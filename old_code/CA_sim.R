...
prior_a <- apply(out[,1:4], 2, mean) %>% round(3)
prior_se_a <- apply(out[,1:4], 2, sd) %>% round(3)
...
e_max_a <- e_likelihood(p_max, parms, data_a$theta1, data_a$theta2, sorted = T)
e_mix_a <- e_likelihood(data_a[models], parms, data_a$theta1, data_a$theta2, sorted = T)


# Process loss
pl_max_a <- 1 - PL(e_max_a, parms, data_a$theta1, data_a$theta2)
pl_mix_a <- 1 - PL(e_mix_a, parms, data_a$theta1, data_a$theta2)
max(pl_mix_a)
...
prior_b <- apply(out[,1:4], 2, mean) %>% round(3)
prior_se_b <- apply(out[,1:4], 2, sd) %>% round(3)
...
e_max_b <- e_likelihood(p_max, parms, data_b$theta1, data_b$theta2, sorted = T)
e_mix_b <- e_likelihood(data_b[models], parms, data_b$theta1, data_b$theta2, sorted = T)

# Process loss
pl_max_b <- 1 - PL(e_max_b, parms, data_b$theta1, data_b$theta2)
pl_mix_b <- 1 - PL(e_mix_b, parms, data_b$theta1, data_b$theta2)
...
prior_c <- apply(out[,1:4], 2, mean) %>% round(3)
prior_se_c <- apply(out[,1:4], 2, sd) %>% round(3)
...
e_max_c <- e_likelihood(p_max, parms, data_c$theta1, data_c$theta2, sorted = T)
e_mix_c <- e_likelihood(data_c[models], parms, data_c$theta1, data_c$theta2, sorted = T)

# Process loss
pl_max_c <- 1 - PL(e_max_c, parms, data_c$theta1, data_c$theta2)
pl_mix_c <- 1 - PL(e_mix_c, parms, data_c$theta1, data_c$theta2)
